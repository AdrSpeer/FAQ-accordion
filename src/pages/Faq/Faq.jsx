  ...
  return (
    <section className="faq">
      <article>
        <h1>FAQs</h1>
        <FaqBoxes
          headline="What is Frontend Mentor, and how will it help me?"
        ...
        />
        <FaqBoxes
          headline="Is Frontend Mentor free?"
        ...
        />
        <FaqBoxes
          headline="Can I use Frontend Mentor projects in my portfolio?"
        ...
        />
        <FaqBoxes
          headline="How can I get help if I'm stuck on a Frontend Mentor challenge?"
